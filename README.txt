...
Game Summary
This is a simple HTML5 canvas game where you control 1 football player and attempt to score a touchdown against 7+ randomly moving opposing football players.
...
**One Note -- There is a current bug where the opponent creation messes up on the 2nd play through, so the browser will need to be refreshed before starting a new game. This is something that will be fixed in future versions.
